...
export function RestaurantLayer() {
  return (
    <section id="restaurants" className="rd-section rd-rest">
      <div className="rd-container rd-rest__intro">
        <motion.div
          className="rd-rest__intro-text"
        ...
        <EditorialImage
          className="rd-rest__intro-img"
          src="/redesign/img/dining-warm.jpg"
          alt="A warm bistro dining room, tables set for the evening service"
          tint="soft"
        />
      </div>
