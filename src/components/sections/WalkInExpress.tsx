    ...
    useEffect(() => {
        const ctx = gsap.context(() => {
            ...
            tl.fromTo(phoneRef.current,
                ...
                { y: -10, opacity: 1, rotateX: 0, duration: 1, ease: 'power3.out' }
            )
                ...
                .to(phoneRef.current, { y: -10, scale: 1, duration: 0.2, ease: 'power2.out' })
                // 5. Hold
                .to({}, { duration: 2.5 })
                // 6. Phone slides away
                .to(phoneRef.current, { y: 80, opacity: 0, duration: 0.8, ease: 'power3.in' })
                // 7. Reset text
                .call(() => {
            ...
            <div className="feature-reveal grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 items-center">
                <div className="flex flex-col gap-6">
                    ...
                    <h2 className="font-serif italic text-4xl md:text-6xl lg:text-7xl text-silver/90 leading-[1.04] tracking-tight">
                        <CinematicText text="Skip the host." />
                        <br />
                        <span className="text-yuzu"><CinematicText text="Just tap." delay={0.2} /></span>
                    </h2>
                ...
                <div className="relative w-full h-[600px]">
                    <ParallaxSection speed={0.15} className="absolute inset-0">
                        <div className="relative p-12 h-full flex items-center justify-center perspective-[1000px]">
                            ...
                            <div ref={phoneRef} className="relative z-10 w-52 h-[340px] bg-[#1A1A1A] border-4 border-[#333] rounded-[2.5rem] shadow-[0_30px_60px_rgba(0,0,0,0.9),inset_0_2px_10px_rgba(255,255,255,0.1)] flex flex-col items-center justify-start p-4 origin-bottom overflow-hidden">
                                ...
                                <div className="mt-8 w-full flex flex-col gap-2">
                                    ...
                                    <div
                                        ref={textRef}
                                        className={`w-full p-4 rounded-2xl bg-[#111] backdrop-blur-md border border-white/10 shadow-lg flex flex-col gap-1 transition-all duration-300 ${pulseText.includes('Table') ? 'translate-y-0 opacity-100 card-beam' : '-translate-y-4 opacity-0'}`}
                                    >
